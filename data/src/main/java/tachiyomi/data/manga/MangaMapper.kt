...
object MangaMapper {
    ...
    fun mapLibraryManga(
        ...
        isSyncing: Long,
        totalCount: Double,
        uniqueChapterCount: Long,
        readCount: Double,
        uniqueChapterReadCount: Double,
        latestUpload: Long,
    ...
    fun mapLibraryView(libraryView: LibraryView): LibraryManga {
        return LibraryManga(
            ...
            totalChapters = libraryView.totalCount.toLong(),
            uniqueChapterCount = libraryView.uniqueChapterCount,
            readCount = libraryView.readCount.toLong(),
            uniqueChapterReadCount = libraryView.uniqueChapterReadCount.toLong(),
